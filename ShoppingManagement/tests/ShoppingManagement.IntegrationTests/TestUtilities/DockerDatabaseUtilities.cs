namespace ShoppingManagement.IntegrationTests.TestUtilities;
...
public static class DockerDatabaseUtilities
{
    ...
    private const string DB_NAME = "ShoppingManagement";
    private const string DB_IMAGE = "postgres";
    private const string DB_IMAGE_TAG = "latest";
    private const string DB_CONTAINER_NAME = "IntegrationTesting_ShoppingManagement";
    private const string DB_VOLUME_NAME = "IntegrationTesting_ShoppingManagement";
