...
public class ShoppingListForManipulationDtoValidator<T> : AbstractValidator<T> where T : ShoppingListForManipulationDto
{
    public ShoppingListForManipulationDtoValidator()
    {
